...
public class AdClickTrendImpl implements IAdClickTrendDAO {
    ...
    public void updateBatch(List<AdClickTrend> adClickTrends) {
        ...
        for(AdClickTrend adClickTrend : adClickTrends) {
            ...
            Object[] params = new Object[]{adClickTrend.getDate(), adClickTrend.getHour(), adClickTrend.getMinute(), adClickTrend.getAdid()};
        ...
        for(AdClickTrend adClickTrend : updateAdClickTrends) {
            ...
            Object[] params = new Object[]{adClickTrend.getClickCount(), adClickTrend.getDate(), adClickTrend.getHour(), adClickTrend.getMinute(), adClickTrend.getAdid()};
        ...
        for(AdClickTrend adClickTrend : insertAdClickTrends) {
            Object[] params = new Object[]{adClickTrend.getDate(), adClickTrend.getHour(), adClickTrend.getMinute(), adClickTrend.getAdid(), adClickTrend.getClickCount()};
